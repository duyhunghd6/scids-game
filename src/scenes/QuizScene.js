...
export class QuizScene extends Phaser.Scene {
  ...
  create() {
    ...
    bg.fillGradientStyle(0x191428, 0x191428, 0x2b2b45, 0x2b2b45, 1);
  ...
  createAnswerButton(x, y, w, h, text, index, question) {
    ...
    hitArea.on('pointerdown', () => {
      ...
      if (isCorrect) {
        ...
        bg.clear();
        bg.fillStyle(0x38b764, 1); // success color
        bg.fillRoundedRect(-w / 2, -h / 2, w, h, 12);
        ...
        this.refreshPowerUpStatus();
        bg.clear();
        bg.fillStyle(0xd21f3c, 1); // danger color
        bg.fillRoundedRect(-w / 2, -h / 2, w, h, 12);
  ...
  createSecretAnswerButton(x, y, w, h, text, index, question) {
    ...
    hitArea.on('pointerover', () => {
      if (this.answered) return;
      bg.clear();
      bg.fillStyle(0x106ad2, 1); // highlight
      bg.fillRoundedRect(-w / 2, -h / 2, w, h, 12);
      bg.lineStyle(2, 0xffffff, 1);
      bg.strokeRoundedRect(-w / 2, -h / 2, w, h, 12);
    });
    ...
    hitArea.on('pointerdown', () => {
      ...
      bg.clear();
      bg.fillStyle(isCorrect ? 0x38b764 : 0xd21f3c, 1);
      bg.fillRoundedRect(-w / 2, -h / 2, w, h, 12);
